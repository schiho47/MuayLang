...
export const basicVowels = [
  ...
  export const complexVowels = [
    {
      pairId: 'e',
      short: { id: 'v_e_s', char: 'เ◌ะ', closed: 'เ◌็◌', roman: 'e' },
      long: { id: 'v_e_l', char: 'เ', closed: 'เ', roman: 'e:' }
    },
    {
      pairId: 'ae',
      short: { id: 'v_ae_s', char: 'แ◌ะ', closed: 'แ◌็◌', roman: 'ae' },
      long: { id: 'v_ae_l', char: 'แ', closed: 'แ', roman: 'ae:' }
    },
    {
      pairId: 'o',
      short: { id: 'v_o_s', char: 'โ◌ะ', closed: '◌ (隱形)', roman: 'o' },
    ...
    },
    {
        ...
        long: { 
          ...
          specialClosed: {
            ending: 'ย',
            form: 'เ◌ย' // 當尾音是 ย 時，上面的 ิ 會消失 (如: เคย)
          },
          roman: 'ə:', 
          note: 'Long oee' 
        }
  ...
  export const specialVowels = [
    { id: 'v_am', char: 'ำ', roman: 'am' },
    { id: 'v_ai_1', char: 'ไ', roman: 'ai' },
    { id: 'v_ai_2', char: 'ใ', roman: 'ai' },
    { id: 'v_au', char: 'เา', roman: 'au' }
  ];