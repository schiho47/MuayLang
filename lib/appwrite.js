...
export const APPWRITE_ENDPOINT =
  process.env.NODE_ENV === 'development'
    ? process.env.EXPO_LOCAL_APPWRITE_ENDPOINT || DEFAULT_APPWRITE_ENDPOINT
    : process.env.EXPO_PUBLIC_APPWRITE_ENDPOINT || DEFAULT_APPWRITE_ENDPOINT

export const AUTH_API_BASE =
  process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://api.muaylang.app'

export const APPWRITE_PROJECT_ID = '68600758001987d2867d'
