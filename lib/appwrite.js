...
const PUBLIC_APPWRITE_ENDPOINT =
  process.env.EXPO_PUBLIC_APPWRITE_ENDPOINT || 'https://api.muaylang.app/v1'
export const APPWRITE_ENDPOINT =
  process.env.NODE_ENV === 'development'
    ? DEFAULT_APPWRITE_ENDPOINT
    : PUBLIC_APPWRITE_ENDPOINT || DEFAULT_APPWRITE_ENDPOINT

console.log('Current Appwrite Endpoint:', APPWRITE_ENDPOINT)
